...
class Missionary {
    ...
    init(name: String, image: String, infoShort: String, infoLong: String, favoriteVerse: String, email: String) {
        self.name = name
        self.image = image
...
"""
    var abale = Missionary(name: "Pastor John Bosco and Janay Abale", image: "abale", infoShort: abaleinfoShort, infoLong: abaleinfoLong, favoriteVerse: abalefavoriteVerse, email: "pippil88@yahoo.com")
...
n/a
"""
var agabe = Missionary(name: "Pastor Chris Agabe", image: "agaba", infoShort: agabeinfoShort, infoLong: agabeinfoLong, favoriteVerse: agabefavoriteVerse, email: "agabachris786@gmail.com")
...
"""
    var bastia = Missionary(name: "Pastor Huguener Bastia", image: "bastia", infoShort: bastiainfoShort, infoLong: bastiainfoLong, favoriteVerse: bastiafavoriteVerse, email: "cccgetsaved@yahoo.com")
...
"""
    var breznau = Missionary(name: "Becky Breznau", image: "breznau", infoShort: breznauinfoShort, infoLong: breznauinfoLong, favoriteVerse: breznaufavoriteVerse, email: "becky.breznau@yahoo.com")
...
"""
    var chinamissionary = Missionary(name: "China Missionaries", image: "china", infoShort: chinamissionaryinfoShort, infoLong: chinamissionaryinfoLong, favoriteVerse: chinafavoriteVerse, email: "")
...
"""
    var daliya = Missionary(name: "Pastor Manoj and Nasreen Daliya", image: "daliya", infoShort: daliyainfoShort, infoLong: daliyainfoLong, favoriteVerse: daliyafavoriteVerse, email: "daliya.manoj@gmail.com")
...
"""
    var davis = Missionary(name: "Jim and Shonda Davis", image: "davis", infoShort: davisinfoShort, infoLong: davisinfoLong, favoriteVerse: davisfavoriteVerse, email: "ptadavis@aol.com")
...
"""
    var diego = Missionary(name: "Iyana Diego", image: "iyana", infoShort: diegoinfoShort, infoLong: diegoinfoLong, favoriteVerse: diegofavoriteVerse, email: "iyanana95@gmail.com")
...
"""
    var douglass = Missionary(name: "Pastor Rob and Heidi Douglass", image: "douglass", infoShort: douglassinfoShort, infoLong: douglassinfoLong, favoriteVerse: douglassfavoriteVerse, email: "douglass.rob@gmail.com")
...
"""
    var emuku = Missionary(name: "Pastor Juventine and Elizabeth Emuku", image: "emuku", infoShort: emukuinfoShort, infoLong: emukuinfoLong, favoriteVerse: emukufavoriteVerse, email: "emukujuv@yahoo.com")
...
"""
    let gaonafavoriteVerse = """
            n/a
"""
    var gaona = Missionary(name: "Pastor Bond and Heather Gaona", image: "gaona", infoShort: gaonainfoShort, infoLong: gaonainfoLong, favoriteVerse: gaonafavoriteVerse, email: "bond@sgwm.com")
...
"""
    var garcia = Missionary(name: "Aaron and Jenna Garcia", image: "garcia", infoShort: garciainfoShort, infoLong: garciainfoLong, favoriteVerse: garciafavoriteVerse, email: "garciaccwgmissions@gmail.com")
...
"""
    var hernandez = Missionary(name: "Amy Hernandez", image: "amyhernandez", infoShort: hernandezinfoShort, infoLong: hernandezinfoLong, favoriteVerse: hernandezfavoriteVerse, email: "amyisabel3@yahoo.com")
...
"""
    var courtneyNusslock = Missionary(name: "Courtney Nusslock", image: "courtneynusslock", infoShort: courtneyinfoShort, infoLong: courtneyinfoLong, favoriteVerse: courtneyfavoriteVerse, email: "cjnusslock@icloud.com")
...
"""
    var nelson = Missionary(name: "Dane Nelson", image: "dane", infoShort: nelsoninfoShort, infoLong: nelsoninfoLong, favoriteVerse: nelsonfavoriteVerse, email: "dane5golf@mgail.com")
...
"""
    var nusslock = Missionary(name: "Jeff and Burnadette Nusslock", image: "nusslock", infoShort: nusslockinfoShort, infoLong: nusslockinfoLong, favoriteVerse: nusslockfavoriteVerse, email: "compeloutreach@gmail.com")
...
"""
    var onzima = Missionary(name: "Pastor David and Medline Onzima", image: "onzima", infoShort: onzimainfoShort, infoLong: onzimainfoLong, favoriteVerse: onzimafavoriteVerse, email: "calvarychapelarua@gmail.com")
...
"""
    var nyika = Missionary(name: "Pastor James and Jane Nyika", image: "nyika", infoShort: nyikainfoShort, infoLong: nyikainfoLong, favoriteVerse: nyikafavoriteVerse,email: "jamesandjanenyika@gmail.com")
...
"""
    var sarkar = Missionary(name: "Pankaj and Tonielle Sarkar", image: "sarkar", infoShort: sarkarinfoShort, infoLong: sarkarinfoLong, favoriteVerse: sarkarfavoriteVerse, email: "sarkar@sgwm.com")
...
"""
    var vincent = Missionary(name: "Pastor Mike and Sarah Vincent", image: "vincent", infoShort: vincentinfoShort, infoLong: vincentinfoLong, favoriteVerse: vincentfavoriteVerse, email: "calvarychapelrosarito@yahoo.com")
...
"""
    var wright = Missionary(name: "Brandon Wright", image: "wright", infoShort: wrightinfoShort, infoLong: wrightinfoLong, favoriteVerse: wrightfavoriteVerse, email: "bwrightttt23@gmail.com")
